var KTSelect2 = {
    init: function() {
        $("#kt_select2_1_1, #kt_select2_1_validate").select2({
            placeholder: "Select a state"
        }), $("#kt_select2_1_2, #kt_select2_1_validate").select2({
            placeholder: "Select a state"
        }), $("#kt_select2_1_3, #kt_select2_1_validate").select2({
            placeholder: "Select a state"
        }), $("#kt_select2_1_4, #kt_select2_1_validate").select2({
            placeholder: "Select a state"
