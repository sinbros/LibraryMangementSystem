...
@section('navNewsMenu','kt-menu__item--active')
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <table class="kt-datatable table-hover" id="html_table" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $data->id}}</td>
                                <td><img style="border-radius:10px" src='{{URL::to("/")}}/images/{{ $data->news_image}}' width="100px" height="100px"> </td>
                            ...
                            <div class="modal fade" id="delete_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('news.destroy',$data->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <center>
                                                        ...
                                                        <img style="border-radius:10px" class="pro_img2" id="pro_img" width="180px" height="200px" src='{{URL::to("/")}}/images/{{ $data->news_image}}' alt="image">
                                                        </div>
                                                    </center>
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            <strong>Select Image :</strong>
                                                            <input onchange="readURL2(this);" type="file" name="news_image" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xs-8 col-sm-8 col-md-8">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{$data->news_title}}" type="text" name="news_title" class="form-control" placeholder="News Title">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="news_des" class="form-control" rows="10">{{$data->news_des}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class = "form-control " name="news_status">
                                                                <option value="1" {{$data->news_status == '1' ? 'selected' : ''}}>Active</option>
                                                                <option value="2" {{$data->news_status == '2' ? 'selected' : ''}}>Deactive</option>
                                                            </select>
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Select Image :</strong>
                                <input onchange="readURL(this);" type="file" name="news_image" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-8 col-sm-8 col-md-8">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>News Description:</strong>
                                <textarea name="news_des" class="form-control" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>News Status:</strong>
                            <select class = "form-control kt-selectpicker" name="news_status">
                                <option value="1">Active</option>
                                <option value="2">Deactive</option>
                            </select>
                        </div>
