...
@section('navPublisherListing','kt-menu__item--active')
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 order-2 order-xl-1">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                        <form id="del_form" action="{{ route('publisher.mul_delete') }}" method="post">
                                            {{ csrf_field() }}
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <hr>
                                            <pre style="font-size: 16px;font-family: arial">Year:         {{ $data->publisher_name }}</pre>
                                            <hr>
                            ...
                            <div class="modal fade" id="delete_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('publisher.destroy',$data->id) }}" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <center>
                            ...
                            <div class="modal fade" id="update_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('publisher.update',$data->id) }}" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $data->publisher_name }}" name="publisher_name" class="form-control" placeholder="Publisher Name">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Publisher Status:</strong>
                                                    <select class = "form-control" name="publisher_status">
                                                        <option value="1" {{$data->publisher_status == '1' ? 'selected' : ''}}>Active</option>
                                                        <option value="2" {{$data->publisher_status == '2' ? 'selected' : ''}}>Deactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Publisher Status:</strong>
                        <select class = "form-control kt-selectpicker" name="publisher_status">
                            <option value="1">Active</option>
                            <option value="2">Deactive</option>
                        </select>
                    </div>
