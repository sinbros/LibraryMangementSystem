...
@section('navCollegeListing','kt-menu__item--active')
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 order-2 order-xl-1">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                        <form id="del_form" action="{{ route('college.mul_delete') }}" method="post">
                                            {{ csrf_field() }}
                    ...
                    <table class="kt-datatable table-hover" id="html_table" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->college_address }}</td>
                                <td>{{ $data->college_contact }}</td>
                                <td>{{ $data->college_status }}</td>
                                <td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <pre style="font-size: 16px;font-family: arial">Name:         {{ $data->college_name }}</pre>
                                            <hr>
                                            <pre style="font-size: 16px;font-family: arial">Address:     {{ $data->college_address }}</pre>
                                            <hr>
                                            <pre style="font-size: 16px;font-family: arial">Contact:      {{ $data->college_contact }}</pre>
                                            <hr>
                                            <pre style="font-size: 16px;font-family: arial">Email:         {{ $data->college_email }}</pre>
                                            <hr>
                            ...
                            <div class="modal fade" id="delete_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('college.destroy',$data->id) }}" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <center>
                            ...
                            <div class="modal fade" id="update_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('college.update',$data->id) }}" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $data->college_name }}" name="college_name" class="form-control" placeholder="College Name">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>College Address:</strong>
                                                    <input type="text" value="{{ $data->college_address }}" name="college_address" class="form-control" placeholder="College Address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $data->college_contact }}" name="college_contact" class="form-control" placeholder="Contact">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Email ID:</strong>
                                                    <input type="email" value="{{ $data->college_email }}" name="college_email" class="form-control" placeholder="Email ID">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class = "form-control" name="college_status">
                                                        <option value="1" {{$data->college_status == '1' ? 'selected' : ''}}>Active</option>
                                                        <option value="2" {{$data->college_status == '2' ? 'selected' : ''}}>Deactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>College Address:</strong>
                        <input type="text" name="college_address" class="form-control" placeholder="College Address">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Contact:</strong>
                        <input type="text" name="college_contact" class="form-control" placeholder="Contact">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Email ID:</strong>
                        <input type="email" name="college_email" class="form-control" placeholder="Email ID">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Department Status:</strong>
                        <select class = "form-control kt-selectpicker" name="college_status">
                            <option value="1">Active</option>
                            <option value="2">Deactive</option>
                        </select>
                    </div>
